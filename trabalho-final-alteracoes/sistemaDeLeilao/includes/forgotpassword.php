...
if(isset($_POST['update']))
{
  ...
  if($query -> rowCount() > 0)
  {
    ...
    echo "<script>alert('ID de e-mail ou número de celular é inválido');</script>"; 
  }
}
...
<div id="forgotpassword" class="modal fade">
        ...
        <div class="login_wrap">
          <div class="col-md-12 col-sm-6">
           <form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <input type="text" name="mobile" class="form-control" placeholder="Nº de telefone*" required="">
            </div>
            <div class="form-group">
              <input type="password" name="newpassword" class="form-control" placeholder="nova senha*" required="">
            </div>
            <div class="form-group">
  ...
  <div class="modal-footer ">
    <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Voltar ao Login</a></p>
  </div>
  <!-- /.modal-content -->
</div>

      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          <a class="dropdown-item" href="profile.php">
            <i class="mdi mdi-account mr-2 text-success"></i> Perfil </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="change_password.php"><i class="mdi mdi-settings mr-2 text-success"></i> definições </a>
            <div class="dropdown-divider"></div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              <h6 class="p-3 mb-0">Você tem <?php echo htmlentities($totalnewbooking);?> nova notificação</h6>
              <div class="dropdown-divider"></div>
              <?php
                ...
                {              
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                      ...
                      <p class="text-gray ellipsis mb-0">Oferta feita</p>
                    </div>
                  </a>
                  <?php 
                }
              } else {?>
                <a class="dropdown-item" href="#">Nenhuma nova oferta recebida</a>
              <?php } ?>
              <div class="dropdown-divider"></div>
              <h6 class="p-3 mb-0 text-center"> <a href="new_bookings.php">Ver todas novas ofertas</a></h6>
            </div>
          </li>

    ...
    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
        <thead>
            <tr>
                ...
                <th class="">Nome</th>
                <th class="">Nº de Telefone</th>
                <th class="">E-mail</th>
                <th class="">Usuário Registado</th>
                <th class="" style="width: 15%;">Acção</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if($query->rowCount() > 0)
            {
                ...
                {    
                    ...
                    <tr>
                        ...
                        <td class=""><a href="deleted_users.php?restoreid=<?php echo ($row->ID);?>" onclick="return confirm('Você realmente quer restourar este usuário ?');" title="restaurar este usuário">restaurar</i></a> </td>
                    </tr>
                    <?php $cnt=$cnt+1;
                }
            } ?>

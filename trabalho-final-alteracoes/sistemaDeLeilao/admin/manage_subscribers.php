            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Gerenciar Assinantes</h5>
                </div>
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      { 
                       ...
                       <tr>
                        ...
                        <td>
                          <a href="manage_subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('Você quer apagar?');"><i class="mdi mdi-delete"></i></a>
                        </td>

            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Registro de marca</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Nome da marca</label>
                      <input type="text" name="brandname" class="form-control" value="" id="brandname" placeholder="Digita a marca" required>
                    </div>
                  </div>
                  <button type="submit" style="float: left;" name="save" class="btn btn-primary btn-sm mr-2 mb-4">Salvar</button>
                </form>
              </div>
            </div>
          </div>
              ...
              <div id="editData4" class="modal fade">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Editar detalhes da marca</h5>
                      ...
                      {     
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($result->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>&nbsp;&nbsp;
                            <a href="brand.php?del=<?php echo $result->id;?>" onclick="return confirm('Você quer apagar?');"><i class="mdi mdi-delete"></i></i></a></td>

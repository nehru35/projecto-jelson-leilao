...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12">
                          ...
                          <a href="update_image.php?id=<?php echo $adminid;?>">Alterar imagem</a>
                      </div>
                  </div>       
                  <?php 
              }
          ...
          <br>
          <button type="submit" name="submit" class="btn btn-primary btn-fw mr-2" style="float: left;">Actualizar</button>
      </form>
  </div>
</div>
</div>

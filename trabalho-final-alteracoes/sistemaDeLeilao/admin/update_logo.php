...
{ 
  ...
  // move the uploaded (temporary) file to the specified destination
    if (move_uploaded_file($file, $destination)) {
      ...
      $query->execute();
      if ($query->execute()){
        echo '<script>alert("Logo da empresa atualizado com sucesso")</script>';
      }else{
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <div class="control-group">
                          <label class="control-label" for="basicinput">Nome da Empresa</label>
                          <div  class="col-6">
                        ...
                        <br>
                        <div class="control-group"> 
                          <label class="control-label" for="basicinput">Logo actual</label>
                          <div class="controls">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group col-xs-12">
                            ...
                            <span class="input-group-append">
                              <button class="file-upload-browse btn btn-gradient-primary" type="button">Actualizar</button>
                            </span>
                          </div>
                        </div>
                      <?php }} ?>

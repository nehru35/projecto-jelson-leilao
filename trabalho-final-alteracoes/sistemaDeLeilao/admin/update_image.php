...
if(isset($_POST['submit']))
{
  ...
  $query->execute();
  $_SESSION['msg']="Imagem d perfil alterada com sucesso !!";
  }
  ?>
                   ...
                   <div class="card-body">
                    ...
                    {?>
                      <div class="alert alert-success">
                        ...
                        <strong>Bem feito!</strong> <?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
                        </div>
                      <?php } ?>
                    <br/>
                    <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
                      ...
                      <br>
                      <div class="control-group"> 
                        <label class="control-label" for="basicinput">Imagem actual</label>
                        <div class="controls">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <div class="input-group col-xs-12">
                          ...
                          <span class="input-group-append">
                            <button class="file-upload-browse btn btn-gradient-primary" type="button">Carregar</button>
                          </span>
                        </div>
                      </div>
                      <?php }} ?>

                ...
                <div class="panel-body">
                  <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Imagem atual 3</label>
                      <?php 
                      $id=intval($_GET['imgid']);
                    ...
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Carregar nova imagem 3<span style="color:red">*</span></label>
                      <div class="col-sm-8">
                    ...
                    <div class="form-group">
                      <div class="col-sm-8 col-sm-offset-4">
                        ...
                        <button class="btn btn-primary" name="update" type="submit">Carregar</button>
                      </div>
                    </div>

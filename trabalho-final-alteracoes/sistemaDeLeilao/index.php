      ...
      <section id="services">
        <div class="container">
          <div class="section-header">
            <h2>Encontre o melhor carro para você</h2>
            <p>Faça uma óptima escolha e seja feliz </p>
          </div>
                ...
                <div class="box wow  fadeInLeft">
                  <div class="car-info-box">
                    ...
                    <div class="car-title-m">
                      ...
                      <span class="price">Kzs<?php echo htmlentities($result->PricePerDay);?> /Valor inicial</span> 
                    </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              <h3 class="cta-title">Obtenha nosso serviço</h3>
              <p class="cta-text"> Serviço de qualidade para facilitar o cidadão.  
              Entre em contacto com a quipa responsável para melhor esclarecimento.</p>
            </div>

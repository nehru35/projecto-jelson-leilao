...
{ 
  ...
  <head>
    <meta charset="utf-8">
    <title>Sistema de Leilão PNA</title>
  ...
  <body id="body">
    ...
    <section id="innerBanner"> 
      <div class="inner-content">
        <h2><span>Perfil</span><br>Melhores ofertas</h2>
        <div> 
        </div>
      </div> 
    </section><!-- #Page Banner -->
                      ...
                      <div class="profile_wrap">
                        ...
                        <form  method="post">
                          ...
                          <?php if($result->UpdationDate!="")
                          {
                            ?>
                            <div class="form-group">
                              <label class="control-label">Última atualização em  -</label>
                          ...
                          <div class="form-group">
                            <button type="submit" name="updateprofile" class="btn btn-primary"  style="background-color: #49a3ff;"  >Salvar alterações <span class="angle_arrow"><i class="fa fa-angle-right"  style="color: #49a3ff;"  aria-hidden="true"></i></span></button>
                          </div>
                        </form>
                      </div>
                    </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-9 text-center text-lg-left">
                  <h3 class="cta-title">Faça sua oferta</h3>

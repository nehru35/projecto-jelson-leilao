  ...
  <body id="body">
   ...
   <section id="innerBanner"> 
    <div class="inner-content">
      <h2><span>Minhas ofertas</span><br>Aqui tens os carros que queres para ti</h2>
      <div> 
      </div>
    </div> 
  </section><!-- #Page Banner -->
            ...
            <div class="col-md-3 col-sm-3">
             ...
             <div class="col-md-8 col-sm-8">
              <div class="profile_wrap">
                <h5 class="uppercase underline">Minhas ofertas </h5>
                <div class="my_vehicles_list">
                  <ul class="vehicle_listing">
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <li>
                          <h4 style="color:red">Nenhuma oferta. &nbsp;<?php echo htmlentities($result->BookingNumber);?></h4>
                         ...
                         <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Ainda não confirma</a>
                          <div class="clearfix"></div>
                        </div>
                        <?php 
                      } ?>
                  ...
                  <h5 align="center" style="color:red">Nenhuma oferta ainda</h5>
                  <?php 
                } ?>
              </ul>
            </div>

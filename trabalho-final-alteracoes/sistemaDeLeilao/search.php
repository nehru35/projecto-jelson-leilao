...
<head>
  <meta charset="utf-8">
  <title>Leilão de veículos PNA</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span > <h1 style="color: #ffffff; font-size: 35px;">Resultado da pesquisa da palavra-chave "<?php echo $_POST['searchdata'];?>"</h1></span><br>Nós fornecemos carros de alta qualidade!</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
          ...
          {  
            ...
            <div class="product-listing-m gray-bg" >
              ...
              <div class="product-listing-content">
                ...
                <a href="car_details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn" style="background-color: #49a3ff;">Ver detalhas <span class="angle_arrow"><i class="fa fa-angle-right" style="color: #49a3ff; "  aria-hidden="true"></i></span></a>
              </div>
            </div>
            <?php 
          }
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 text-center text-lg-left">
        <h3 class="cta-title">Melhores preços</h3>
        <p class="cta-text">Qualidade e vantagem para melhor servir o cidadão</p>
      </div>

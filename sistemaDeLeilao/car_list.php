...
<head>
  <meta charset="utf-8">
  <title>Leilão de viaturas PNA</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>Lista de carros disponíveis</span><br>todos carros legalizados</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
              ...
              <div class="col-md-9 col-md-push-3">
                <div class="result-sorting-wrapper">
                  <div class="sorting-count">
                    ...
                    $cnt=$query->rowCount();
                    ?>
                    <p><span><?php echo htmlentities($cnt);?> Listagens</span></p>
                  </div>
                </div>
                  ...
                  {  
                    ...
                    <div class="product-listing-m gray-bg">
                      ...
                      <div class="product-listing-content">
                        ...
                        <p class="list-price">Kzs<?php echo htmlentities($result->PricePerDay);?> Valor inicial</p>
                        <ul>
                        ...
                        <a href="car_details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn" style="background-color: #49a3ff;" >Ver detalhes <span class="angle_arrow"><i class="fa fa-angle-right" style="color: #49a3ff; " aria-hidden="true"></i></span></a>
                      </div>
                    </div>
                    <?php
                  }
                        ...
                        {  
                          ...
                          <li class="gray-bg">
                            ...
                            <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                              <p class="widget_price">Kzs<?php echo htmlentities($result->PricePerDay);?> Valor inicial</p>
                            </div>
                          </li>
                          <?php 
                        }
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              <h3 class="cta-title">Faça a sua oferta</h3>
              <p class="cta-text">Faça uma boa escolha de lote e bons remates para poder alcançar o sonho de ter o carro próprio.</p>
            </div>
            <div class="col-lg-3 cta-btn-container text-center">
              <a class="cta-btn align-middle" href="contact.php">Contacte-nos</a>
            </div>
          </div>

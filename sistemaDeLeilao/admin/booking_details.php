                        ...
                        { 
                          ...
                          <tr>  
                            <td style="text-align:center" colspan="4">
                              <a href="booking_details.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Você realmente deseja Confirmar esta oferta')" class="btn btn-primary"> Confirmar Oferta</a> 

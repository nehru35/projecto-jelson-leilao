          ...
          <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class=" col -md-12 card">
              <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Editar carro</h5>
              </div>
              <?php 
              if($msg){
                ?>
              ...
              if($query->rowCount() > 0)
              {
                ...
                { 
                  ...
                  <div class="col-md-12 mt-4">
                    <div class="row ">
                      <div class="form-group col-md-6 ">
                        <label for="exampleInputPassword1">Selecionar Marca<span style="color:red">*</span></label>
                      ...
                      <div class="form-group col-md-6">
                        <label for="exampleInputName1">Modelo do Carro<span style="color:red">*</span></label>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      <div class="form-group col-md-3">
                        <label for="exampleInputName1">Preço por Dia(em KZs)<span style="color:red">*</label>
                          <input type="text" name="priceperday" value="<?php echo htmlentities($result->PricePerDay);?>" class="form-control" id="price"required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="exampleInputName1">Ano Modelo<span style="color:red">*</label>
                          ...
                          <div class="form-group col-md-3">
                            <label for="exampleInputName1">Selecionar o tipo de combustível<span style="color:red">*</label>
                          ...
                          <div class="row ">
                            <div class="form-group col-md-4 pl-md-0">
                              <label class="col-sm-12 pl-0 pr-0 ">imagem do carro 1</label>
                           ...
                           <div class="form-group col-md-4 pl-md-0">
                            <label class="col-sm-12 pl-0 pr-0 ">imagem do carro 2 </label>
                            <div class="col-sm-12 pl-0 pr-0">
                          ...
                          <div class="form-group col-md-4 pl-md-0">
                            <label class="col-sm-12 pl-0 pr-0 ">imagem do carro 3 </label>
                            <div class="col-sm-12 pl-0 pr-0">
                       ...
                       <div class="row ">
                         <div class="form-group col-md-4 pl-md-0">
                          <label class="col-sm-12 pl-0 pr-0 ">imagem do carro 4 </label>
                          <div class="col-sm-12 pl-0 pr-0">
                        ...
                        <div class="form-group col-md-4 pl-md-0">
                          <label class="col-sm-12 pl-0 pr-0 ">imagem do carro 5</label>
                          <div class="col-sm-12 pl-0 pr-0">
                  ...
                  <div class=" col -md-12 card">
                    <div class="modal-header">
                      <h5 class="modal-title" style="float: left;">Acessórios</h5>
                    </div>
                    <div class="col-md-12 mt-4">
              ...
              <button type="submit" style="float: right;" name="save" class="btn btn-primary btn-sm  mr-2 mb-4">Salvar</button>
            </div>
          </div>
          <?php 
        }

...
?>
<div class="card-body">
  <h4 class="card-title">Atualizar Formulário de Usuário </h4>
  <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    if($query->rowCount() > 0)
    {
      ...
      { 
        ...
        <div class="form-group">
          <label for="exampleInputName1">Número de Telefone.</label>
    ...
    <button type="submit" name="saveupdates" class="btn btn-primary btn-fw mr-2">Salvar</button>

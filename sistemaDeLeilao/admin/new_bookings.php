...
$query -> execute();
 echo "<script>alert('registro do carro deletado.');</script>";
}
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Gerenciar carros</h5>
                </div>
                      ...
                      if($query->rowCount() > 0)
                      {
                        foreach($results as $result)
                        {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="booking_details.php?bid=<?php echo htmlentities($result->id);?>"> ver</a>
                            </td>

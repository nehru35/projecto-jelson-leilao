                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="modal-header">
                                    <h5 class="modal-title" style="float: left;">Detalhes da Companhia</h5>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    if($query->rowCount() > 0)
                                    {
                                        ...
                                        {  
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="row">
                                                    <div class="form-group row col-md-6">
                                                        <label class="col-12" for="register1-username">Nome da Companhia:</label>
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="companyname" value="<?php  echo $row->companyname;?>" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group row col-md-6">
                                                        <label class="col-12" for="register1-email">Nº de Registro da Companhia:</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="form-group row col-md-6">
                                                      <label class="col-12" for="register1-email">Endereço Físico:
                                                      </label>
                                                      <div class="col-12">
                                                ...
                                                <div class="form-group row col-md-6">
                                                    <label class="col-12" for="register1-email">E-mail da Companhia :</label>
                                                    <div class="col-12">
                                            ...
                                            <div class="row"> 
                                                <div class="form-group row col-md-6">
                                                    <label class="col-12" for="register1-password">Cidade:</label>
                                                    <div class="col-12">
                                                        <input type="text" class="form-control" name="country" value="<?php  echo $row->country;?>" required='true' >
                                                    </div>
                                                </div>
                                                <div class="form-group row col-md-6">
                                                    <label class="col-12" for="register1-password">Número de contato:</label>
                                                    <div class="col-12">
                                    ...
                                    <br>
                                    <button type="submit" name="submit" class="btn btn-primary btn-fw mr-2" style="float: left;">Salvar</button>
                                </form>
                            </div>
                        </div>
                    </div>

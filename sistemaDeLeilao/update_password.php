...
{ 
  ...
  if(isset($_POST['updatepass']))
  {
    ...
    if($query -> rowCount() > 0)
    {
      ...
      $chngpwd1->execute();
      $msg="Sua senha alterada com sucesso";
    }
    else {
  ...
  <head>
    <meta charset="utf-8">
    <title>Leilão de veículo PNA</title>
    ...
    <script type="text/javascript">
      function valid()
      {
        ...
        {
          alert("Nova senha e campo Confirmar senha não coincidem  !!");
  ...
  <body id="body">
   ...
   <section id="innerBanner"> 
    <div class="inner-content">
      <h2><span>Perfil</span><br>melhor opção</h2>
      <div> 
      </div>
    </div> 
  </section><!-- #Page Banner -->
                    ...
                    <div class="col-md-6 col-sm-8">
                      <div class="profile_wrap">
                        <form name="chngpwd" method="post" onSubmit="return valid();">
                          ...
                          {
                            ?>
                            <div class="succWrap"><strong>SUCESSO</strong>:<?php echo htmlentities($msg); ?> </div>
                            <?php
                          }?>
